...
<div class="row-fluid">
	<div class="span12">
		<?php if($this->type == 'file'): ?>
			<p class="well well-small lead"><?php echo JText::sprintf('COM_VISFORMS_CSS_FILENAME', $this->source->filename, $this->extension->element); ?></p>
		<?php endif; ?>
	</div>
</div>
<div class="row-fluid">
	...
	<div class="span9">
		<?php if($this->type == 'home'): ?>
			<form action="<?php echo JRoute::_('index.php?option=com_visforms&view=vistools&id=' . $input->getInt('id') . '&file=' . $this->file); ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal">
